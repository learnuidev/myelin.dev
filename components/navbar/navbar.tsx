...
export const NavBar = () => {
  ...
  return (
    <nav className="px-8 py-4 flex justify-between items-center z-50 dark:bg-[rgb(9,10,11)]/75 bg-white/75 dark:bg-react/75 backdrop-blur-sm">
      <Link className="font-bold text-2xl lowercase" href="/">
        {t("title")}
      </Link>
      <div className="flex space-x-2 items-center flex-row">
        <GithubLink href="https://github.com/learnuidev/myelin" />
        <ToggleTheme />
